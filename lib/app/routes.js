...
var livechat       = require("../../SimpleConversationalBot.js");
...
function loadroutes(app) {
    ...
    app.post( apiPrefix, livechat.getWhatsAppMessage);
    // app.get( apiPrefix + 'gethistory', livechat.gethistory);
    app.post( apiPrefix +'agentTransfer', livechat.getAgentMessage);
}
